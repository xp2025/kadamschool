...
function sendemail_verify($name,$email,$token)
{
    ...
    $mail_template = "
                      ...
                      <br/>
                      <a href='http://localhost/Kadambari-Student-Portal/src/student_verify_email.php?token=$token && email=$email'>Click Here</a>
                      ";
...
if (isset($_POST['stu_register_btn'])) {
