                              ...
                              <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      ...
                                      <a class="dropdown-item disabled" href="edit.php?id=<?php echo $row['id'];?>"><i class="fas fa-edit"></i> Edit</a>
                                      <a class="dropdown-item disabled" onclick="return confirm('Are You Sure?')" href="delete.php?id=<?php echo $row['id'];?>"><i class="far fa-trash-alt"></i> Delete</a>
                                    </div>
                                  </div>
                          </td>
                          </tr>
