                        ...
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="fa fa-mouse-pointer" aria-hidden="true"></i>
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                ...
                                <a class="dropdown-item btn btn-danger m-0" onclick="return confirm('Are You Sure?')" href="notice_delete.php?id=<?php echo $file['id'];?>"><i class="far fa-trash-alt" ></i> Delete</a>
                                </div>
                              </div>
                      </td>
                    </tr>
...
<!-- Form Strat from here -->
            <form action="notice_store.php" method="POST"   enctype="multipart/form-data">
                <div class="form-group">
                    <label for="name">Write Title</label>
                    <input type="text" class="form-control" required name="name" placeholder="Enter Write Here" >
                </div>
                    <div class="form-group">
                    <label for="pdf"> <span style="color:green;">Select Only PDF File </label>
                    <br>
